...
contract UniV3Exchange is LeftoversSweep, UniPriceConverter, IExchange {
    ...
    IUSDPToken public immutable boldToken;
    uint24 public immutable fee;
    ISwapRouter public immutable uniV3Router;

    constructor(IERC20 _collToken, IUSDPToken _boldToken, uint24 _fee, ISwapRouter _uniV3Router) {
    ...
    function priceToSqrtPrice(IUSDPToken _boldToken, IERC20 _collToken, uint256 _price) public pure returns (uint160) {
    ...
    function _zeroForOne(IUSDPToken _boldToken, IERC20 _collToken) internal pure returns (bool) {
