...
contract BorrowerOperations is LiquityBase, AddRemoveManagers, IBorrowerOperations {
    ...
    */
    ...
    event USDPTokenAddressChanged(address _boldTokenAddress);
        ...
        LiquityBase(_addressesRegistry)
    {
        ...
        emit USDPTokenAddressChanged(address(boldToken));
    ...
    */
    ...
    function closeTrove(uint256 _troveId) external override {
        ...
        IUSDPToken boldTokenCached = boldToken;
    ...
    function _requireSufficientBoldBalance(IUSDPToken _boldToken, address _borrower, uint256 _debtRepayment)
        internal
        view
    {
