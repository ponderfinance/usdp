...
contract TroveManager is LiquityBase, ITroveManager, ITroveEvents {
    ...
    **/
    ...
    event USDPTokenAddressChanged(address _newUSDPTokenAddress);
    ...
    */
    ...
    function _requireBoldBalanceCoversRedemption(IUSDPToken _boldToken, address _redeemer, uint256 _amount)
        internal
        view
    {
